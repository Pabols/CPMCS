    ...
    <div class="page-header">
        <div class="page-header-content d-sm-flex">
            <div class="page-title">
                <h4><span class="font-weight-semibold">Search Query: <?=date('F j, Y',strtotime(post('from')))?> - <?=date('F j, Y',strtotime(post('to')))?> </span></h4>
            </div>
        </div>
    </div>
    <!-- /page header -->
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table style="width:100%" class="table datatable-button-html5-basic">
                                ...
                                <tbody>
                                    <?php $i=1; foreach(get_report_result($from,$to) as $user) { ?>
                                    <tr>
                                        <td><?=$i++?></td>
            ...
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary btn-sm flat">Search Now</button>
                    </div>
                </div>
            </div>
        </div>
